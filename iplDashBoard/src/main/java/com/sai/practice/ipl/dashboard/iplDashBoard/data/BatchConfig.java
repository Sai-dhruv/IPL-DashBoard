 ...
 private  final String[] FIELD_NAMES  = new String[] {
  ...
  public JdbcBatchItemWriter<MatchData> writer(DataSource dataSource) {
    return new JdbcBatchItemWriterBuilder<MatchData>()
      ...
      .sql("INSERT INTO MATCH_DATA (id,city,date,player_of_match,venue,team1,team2,toss_winner,toss_decision,match_winner,result,result_margin) VALUES (:id,:city,:date,:playerOfMatch,:venue,:team1,:team2,:tossWinner,:tossDecision,:matchWinner,:result,:resultMargin)")
     // .sql("INSERT INTO MATCH_DATA (id,city) VALUES (:id,:city)")
